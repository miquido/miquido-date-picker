...
export var assembleMultiSelectDate = function (startDate, endDate) {
    ...
    return ("" + precedeZeroDayStart + startDay + "/" + precedeZeroMonthStart + startMonth + "/" + startYear + "-\n      " + precedeZeroDayEnd + endDay + "/" + precedeZeroMonthEnd + endMonth + "/" + endYear);
};
...
export var getLastDayOfAMonth = function (year, month) {
    return new Date(year, month + 1, 0).getDate();
};
