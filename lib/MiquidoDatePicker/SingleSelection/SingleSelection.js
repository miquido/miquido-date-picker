...
var SingleSelection = /** @class */ (function (_super) {
    ...
    SingleSelection.prototype.componentWillUpdate = function (newProps, newState) {
        console.log('componentWillUpdate', JSON.stringify(this.state.selectedDate) === JSON.stringify(newProps.defaultValue));
        if ((!Object.is(this.state.selectedDate, newProps.defaultValue) && objectEquals(this.state.selectedDate, newProps.defaultValue)) ||
            (!Object.is(this.props.defaultValue, newProps.defaultValue) && !objectEquals(this.props.defaultValue, newProps.defaultValue))) {
            console.log('componentWillUpdate - true');
            if (newProps.defaultValue) {
                ...
                var updState = {
                    ...
                    selectedDate: __assign({}, this.state.selectedDate, { start: newDefault.start, end: newDefault.end || newDefault.start }),
    ...
    SingleSelection.prototype.setInputDateSchema = function (schema) {
        if (schema === void 0) { schema = 'dd/mm/yyyy'; }
    ...
    SingleSelection.prototype.render = function () {
        return (React.createElement("div", { className: getClassFor({ key: 'pickerWrapper', theme: this.theme, defaultClass: pickerWrapper }), ref: this.node },
            React.createElement(InputComponent, { children: this.props.children, inputValue: this.state.inputValue || (this.state.defaultValue && this.setDefaultDate(this.state.defaultValue)) || '', inputClass: "miquido-date-picker__input " + this.inputClass, onClickHandler: this.onInputClickHandler, onChangeHandler: this.handleChange, disabled: this.state.disabled, placeholder: this.props.placeholder || '', name: this.props.name || '' }),
            React.createElement(CSSTransition, { in: this.state.isPickerVisible, timeout: animationDuration, classNames: 'picker', unmountOnExit: true, onExited: this.closePicker },
                React.createElement("div", { className: getClassFor({ key: 'picker', theme: this.theme, defaultClass: picker }), style: this.positionStyles },
                    ...
                    React.createElement(HeaderMenu, { displayYear: this.state.displayedYear, displayMonth: monthNames[this.state.displayedMonthIndex], switchToYearSelect: this.switchToYearSelect, switchToMonthSelect: this.switchToMonthSelect, nextMonth: this.nextButtonHandler, prevMonth: this.prevButtonHandler, theme: this.theme }),
                    ...
                    React.createElement(PickDay, { pastDaysAmount: getDayOfTheWeek(this.state.displayedMonthIndex, this.state.displayedYear), eventsHandlers: this.eventsHandlers, theme: this.theme, selectedYear: this.state.displayedYear, selectedMonthIndex: this.state.displayedMonthIndex, selection: this.state.selectedDate, restrictions: this.props.restrictions }),
