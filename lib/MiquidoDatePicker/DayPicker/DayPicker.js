...
var PickDay = function (props) {
    ...
    var currentMonthDays = props.days.map(function (value, index) { return (React.createElement(Day, { key: "current-" + index, displayValue: value.displayValue, selected: value.selected, start: value.start, end: value.end, today: value.today, eventsHandlers: props.eventsHandlers, itemIndex: index, theme: props.theme })); });
