...
var Year = function (props) {
    ...
    return (React.createElement("div", { className: className, onClick: function (_) { return props.allowed && props.eventsHandlers && props.eventsHandlers.clickHandler(+props.displayValue); }, onContextMenu: function (_) { return props.allowed && props.eventsHandlers && props.eventsHandlers.clickHandler(+props.displayValue); } },
        props.displayValue,
        props.allowed));
};
export default Year;
