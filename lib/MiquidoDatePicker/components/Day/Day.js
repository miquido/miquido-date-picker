...
var Day = function (props) {
    ...
    var dayClassNames = classNames((_a = {},
        ...
        _a));
    return (React.createElement("div", { className: dayClassNames, onMouseOver: function (_) { return !props.disabled && props.eventsHandlers && props.eventsHandlers.mouseOverHandler && props.eventsHandlers.mouseOverHandler(props.itemIndex); }, onMouseDown: function (_) { return !props.disabled && props.eventsHandlers && props.eventsHandlers.mouseDownHandler(props.itemIndex); }, onMouseUp: function (_) { return !props.disabled && props.eventsHandlers && props.eventsHandlers.mouseUpHandler(props.itemIndex); }, onClick: function (_) { return !props.disabled && props.eventsHandlers && props.eventsHandlers.clickHandler(props.itemIndex); }, onContextMenu: function (_) { return !props.disabled && props.eventsHandlers && props.eventsHandlers.clickHandler(props.itemIndex); } }, displayValue));
};
export default Day;
