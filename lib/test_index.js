    ...
    TestInjection.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(MiquidoDatePicker, { defaultValue: {
                ...
                // @ts-ignore
                inputClass: this.state.inputClass, onSelect: console.log, position: 'bottom' })));
    };
...
export default ReactDOM.render(React.createElement(React.Fragment, null,
    ...
    React.createElement(MiquidoDatePicker, { restrictions: {
        ...
        }, type: 'double', inputClass: 'testingclass123', onSelect: console.log }),
    React.createElement(TestInjection, null),
    React.createElement("div", { style: { position: 'absolute', top: '5vh', right: 0 } },
        React.createElement(MiquidoDatePicker, { position: 'bottom' }))), document.getElementById('root'));
